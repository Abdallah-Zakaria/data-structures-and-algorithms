...
const sortPeopleBetter = (arr) => {
    ...
    return arr.sort((a, b) => {
        if (a.lastName[0].toUpperCase() > b.lastName[0].toUpperCase()) {
            console.log("here")
            return 1
        } else if (a.lastName[0].toUpperCase() < b.lastName[0].toUpperCase()) {
            console.log("here")
            return -1
        } else {
            return age(a, b)
    ...
    function firstName(a, b) {
        ...
        arr.sort((a, b) => {
            if (a.firstName[0].toUpperCase() > b.firstName[0].toUpperCase()) {
                console.log(a.firstName[0], b.firstName[0].toUpperCase())
                returnValue = 1
            } else if (a.firstName[0].toUpperCase() < b.firstName[0].toUpperCase()) {
                console.log(a.firstName[0])
                returnValue = -1
            } else {
...
const sortSchedule = (arr) => {
  ...
  let durSort =  startSort.sort((a,b)=>{
...
const addPearClass = () => {
    // Solution code here...
    $("#fruits").children().last().addClass("pear")
};
