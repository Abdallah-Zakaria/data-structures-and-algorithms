...
const createServer = () => {
    ...
    app.get('/aboutme', renderAboutMe)
    app.get('/favoritefoods', renderFavoritFoods)
    app.use("*", notFound)

    function renderHello(request, response) {
        response.send("hello there")
    }
    function renderAboutMe(request, response) {
        response.send("Iam abdallah zakaria write this code from backend")
    }
    function renderFavoritFoods(request, response) {
...
let findMaleAndFemale = (data) => {
    // Solution code here...
    return data.reduce((str, item, index) => {
...
let findShortest = (data) => {
    // Solution code here...
    return data.reduce((shortestName, item) => {
        if (item.name.length < shortestName.length) {
